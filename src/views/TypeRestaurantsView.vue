...
export default {
    ...
    mounted() {
        ...
        axios.get(this.state.base_url + `api/types/user/${this.$route.params.slug}`)
            .then(response => {
                    ...
                    <div class="col-3">
                        ...
                        <div class="type_list overflow_hidden">
                            <div class="form-check">
                                <div class="text-decoration-none m-1" v-for="(tipo, index) in this.state.types"
                                    :key="tipo.slug">


                                    <input v-model="selectedTypes" @change="handleChange(event, index)"
                                        class="form-check-input" :for="tipo.id" type="checkbox"
                                        :value="'types[]=' + tipo.slug + '&'" :id="tipo.id" />
                            ...
                            <router-link :to="{ name: 'singleRestaurant', params: { slug: restaurant.slug } }"
                                ...
                                <div class="card bg-transparent border-0">
                                    ...
                                    <div class="card-body px-0 py-3">
                                        ...
                                        <div class="row">
                                            <div class="col text-center" v-for="tipo in restaurant.types">
